...
export function buildAgentSystemPrompt(toolNames: string[]): string {
  return [
    ...
    'Final answer LUÔN gồm đúng 2 khối, đúng thứ tự, đúng tiêu đề khối (hệ thống tách tự động theo tiêu đề này):',
    '',
    '## KỊCH BẢN QUAY',
    ...
    '',
    'Trước 2 khối trên, cho phép tối đa 4 dòng ngắn: GIỜ ĐĂNG GỢI Ý / KÊNH PHÙ HỢP / NẤC PHỄU (Attention-Trust-Offer). Không thêm mục nào khác.',
    '',
